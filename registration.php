...
$query="insert into user values('','$n','$mn','$ln','$e','$pass','$mob','$gen','$imageName','$dob','$regid','$pmob','$fname','$mname','$bg')";
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input  type="text"  class="form-control" name="ln" required/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Enter Your Register Number</td>
					<Td><input  type="text"  class="form-control" name="regid" required/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<Td><input  class="form-control" type="number" id="phone"  name="pmob" required/></td>
				</tr>
