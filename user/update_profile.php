...
$query="update user set name='$n',mobile='$mob',gender='$gen',hobbies='$hob',dob='$dob', parentNo='$pmob', fatherName = '$fname', motherName='$mname', BloodGroup='$bg' where email='".$_SESSION['user']."'";
...
<h2 align="center">Update Your Profile</h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Enter Your Parents MobileNo</td>
					<Td><input  class="form-control" type="number" value="<?php echo $res['parentNo'];?>" name="pmob" id="phone" required/></td>
				</tr>

				<tr>
					<td>Enter Your Mother Name</td>
					<Td><input  class="form-control" type="text" name="mname" value="<?php echo $res['motherName'];?>" required/></td>
				</tr>

				<tr>
					<td>Enter Your Father Name</td>
					<Td><input  class="form-control" type="text" name="fname" value="<?php echo $res['fatherName'];?>" required/></td>
				</tr>
				...
				<tr>
					<td>Enter Your Blood_Group</td>
					<Td>
					<select name="bg" required>
					<option value="<?php echo $res['BloodGroup'];?>">BG</option>
