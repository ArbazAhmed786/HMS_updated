            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="login.php"
                  >User login <span class="sr-only"></span></a
                >
              </li>
              <li class="nav-item">
        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption text-left">
              ...
              <p>
                A long Search For Hostel Ended-Up Here!
              </p>
              <p>
                <a class="btn btn-lg btn-primary" href="registration.php" role="button"
                  >Sign up today</a
                >
              </p>
            </div>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <h1>Hostel Management System.</h1>
              <p>
                This Application gives you all the features to easyly Manage ur Room
              </p>
              <p>
                <a class="btn btn-lg btn-primary" href="login.php" role="button"
                  >Hava An Account ?</a
                >
              </p>
            </div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
					<p><u><a href="#"></a></u> </p>
					<p class="h6">&copy All right Reversed.<a class="text-green ml-2" href="" target="_blank">KLE POLYTECHNIC</a></p>
				</div>
				</hr>
			</div>	
    </div>
